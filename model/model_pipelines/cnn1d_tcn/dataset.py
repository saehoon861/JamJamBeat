# cnn1d_tcn/dataset.py - 슬라이딩 윈도우 시퀀스(16 x 63d) Dataset 빌더
...
def build(
    ...
    """
    # CNN/TCN 계열은 raw joint 63차원 시퀀스를 시간축 위에서 직접 처리한다.
    cols = RAW_JOINT_COLS
    ...
    model = TCN1DClassifier(input_dim=len(cols), num_classes=num_classes)
