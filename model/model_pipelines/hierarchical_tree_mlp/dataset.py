# hierarchical_tree_mlp/dataset.py - Raw 63d hand-landmark frame dataset builder for hierarchical tree MLP
...
def build(
    ...
    """Build the hierarchical tree MLP frame pipeline from raw 63D landmarks only."""
    ...
    model = HierarchicalTreeMLP(**model_kwargs)
