# mlp_baseline/dataset.py - joint(63d) 단일 프레임 Dataset 빌더
...
def build(
    ...
    입력: joint(63d) only
    """
    # 가장 단순한 baseline으로, 정규화 joint 좌표 63차원만 그대로 사용한다.
    ...
    model = MLPBaseline(input_dim=len(RAW_JOINT_COLS), num_classes=num_classes)
