# mlp_sequence_delta/model.py - flattened sequence MLP using joint and first-order temporal deltas
import torch.nn as nn


class SequenceDeltaMLP(nn.Module):
    """joint + delta 시퀀스를 flatten해서 읽는 MLP.
    ...
    def forward(self, x_seq):
        # flatten 구조는 유지하되 delta 채널이 시간 변화량을 직접 전달한다.
