# shufflenetv2_x0_5/dataset.py - 랜드마크 → 스켈레톤 이미지 렌더링 Dataset 빌더
from __future__ import annotations

from _shared import LandmarkImageDataset, JOINT_COLS, SplitData, frame_arrays
from .model import ShuffleNetLike
...
def build(
    ...
    """
    # joint 63차원을 1채널 skeleton image로 변환한 뒤 극경량 CNN에 전달한다.
