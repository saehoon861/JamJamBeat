# sparse_masked_mlp/dataset.py - Raw 63d hand-landmark frame dataset builder for sparse masked MLP
from __future__ import annotations

import numpy as np

from _shared import FrameDataset, RAW_JOINT_COLS, SplitData, frame_arrays
from .model import SparseMaskedMLP
...
def build(
    ...
    """Build the sparse masked MLP frame pipeline from raw 63D landmarks only."""
    ...
    model = SparseMaskedMLP(**model_kwargs)
