...
```text
model/동작테스트/raw_data/7_grab.mp4
```
...
- 저장 경로: `model/동작테스트/labeled_data/7_grab.csv`
...
- 저장 후 `model/동작테스트/labeled_data/7_grab.csv` 가 생성되어야 합니다.
