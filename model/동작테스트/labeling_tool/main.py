...
실행 방법:
    $ cd /home/user/projects/JamJamBeat/model/동작테스트/labeling_tool
...
def get_project_paths() -> tuple[str, str]:
    """model/동작테스트 워크스페이스 경로를 계산하여 (raw_data_dir, labeled_data_dir)를 반환합니다."""
    tool_dir = Path(__file__).resolve().parent       # model/동작테스트/labeling_tool/
    workspace_dir = tool_dir.parent                  # model/동작테스트/
